...
\begin{description}[style=nextline]
    ...
    \item[Req. ID] Requirement(s) verified by this test (links to
          Section~\ref{sec:moc}).
    \item[Description of the testing approach] What the test involves and what is being measured.
    \item[Pass Criteria] Measurable condition(s) that must be met to pass.
    \item[Status] \textit{Planned} / \textit{In Progress} / \textit{Pass} /
          \textit{Fail}.
\end{description}

To simplify collaboration, test rows are maintained in team-owned files under
\texttt{teams/*/tests.tex} and then assembled into one master table below.
